                    ...
                    <div class="opsi-pengiriman ps-3 pe-3">
                        <button type="button"
                            @if ($delivery === null)
                                disabled
                            @endif
                        class="btn btn-primary w-100 rounded-pill opsi" data-bs-toggle="modal"
                    ...
                    <div class="d-flex" style="justify-content: space-between;">
                        <div class="image-title d-flex">
                            ...
                            <div class="text" style="max-width: 190px">
                                ...
                                <p class="title-pesanan ms-1 text-muted" style="font-size: 11px">{{ $data->book_qty }}
                                    Barang ({{ $total_weight }} gr)</p>
    ...
    <div class="card shadow-sm p-3 bg-body rounded" style="width: 500px">
        ...
        <div class="kode-promo d-flex p-3" style="justify-content: space-between">
            ...
            <div class="input-group mb-3 px-3">
              <input type="search" disabled class="form-control code" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/>
              <span class="input-group-text btn btn-primary disabled pt-2 use_code" type="button" id="inputGroup-sizing-default" style="font-size: 14px">Gunakan</span>
        ...
        <div class="total-belanja d-flex px-3" style="justify-content: space-between">
            <p>Total Belanja</p>
            <b>@currency($total)</b>
            <input type="hidden" id="harga-total" name="total" value="{{ $total }}">
        </div>
        <div class="total-belanja d-flex px-3" style="justify-content: space-between">
            <p>Diskon Voucher</p>
            <b id="diskon" class="text-danger"> - </b>
        </div>
        ...
        <div class="bayar-pesanan" style="margin: 20px 20px 0px 20px">
            <button type="button" class="btn btn-outline-primary disabled rounded-pill w-100 payment" id="pay-button">Bayar
                Sekarang</button>
        </div>
    </div>
</div>

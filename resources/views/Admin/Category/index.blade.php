      ...
      <div class="col">
          <div class="card">
              <div class="card-body">
                ...
                <a href="/category/form" class="btn btn-success mb-3"><i data-feather="plus-square"></i> Tambah</a> 
                ...
                @foreach ($category as $data)
                  <tr>
                    ...
                    <td>{{ $data->name }}</td>
                    <td>{{ $book->where('category_id', $data->id)->count() }}</td>
                    <td>
                      <a href="{{ url('/category/edit/' . $data->id) }}"><i data-feather="edit"></i></a> &nbsp; | &nbsp;
                      <a href="#" id="delete" data-id="{{ $data->id }}" data-name="{{ $data->name }}"><i class="delete" data-feather="trash-2"></i></a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
